<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"E:\wamp\www\zhongjiang\public/../app/index\view\base\base.html";i:1499136242;s:57:"E:\wamp\www\zhongjiang\public/../app/index\view\base.html";i:1499134147;}*/ ?>
	...
	<div class="neiye clearfix">
    	<div class="neiyeL">
        	<div class="banL noel">
                    ...
                    <li><a href="<?php echo url($vo['url'],['id'=>$vo['id']]); ?>" <?php if(input('param.id')==$vo['id']): ?>class="lanmu"<?php endif; ?>><?php echo $vo['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
          		</div>
      		</div>
