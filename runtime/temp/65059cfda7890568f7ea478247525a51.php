<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\wamp\www\zhongjiang\public/../app/admin\view\message\message.html";i:1498732010;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="text-c">
        <form action="<?php echo url('Message/message'); ?>" method="post">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
	 <a class="btn btn-primary radius" data-title="添加资讯" data-href="<?php echo url('message_add'); ?>" onclick="Hui_admin_tab(this)" href="javascript:;">
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<?php if(is_array($field) || $field instanceof \think\Collection || $field instanceof \think\Paginator): if( count($field)==0 ) : echo "" ;else: foreach($field as $key=>$vo): ?>
				<tr class="text-c">
					...
					<td class="text-l"><?php echo $vo['contacts']; ?></td>
					<td class="text-l"> <?php echo $vo['number']; ?></td>
					<td class="text-l"><?php echo $vo['content']; ?></td>
					 <td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','<?php echo url('message_upd',['id'=>$vo['id']]); ?>','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
