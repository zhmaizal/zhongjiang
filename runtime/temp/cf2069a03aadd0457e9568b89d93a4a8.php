<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\wamp\www\zhongjiang\public/../app/admin\view\login\login.html";i:1497174854;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="utf-8">
		...
		<form class="form form-horizontal" action="" method="post">
			<div class="row cl">
				...
				<div class="formControls col-xs-8">
					<input id="" name="admin_username" type="text" placeholder="账户" class="input-text size-L">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
