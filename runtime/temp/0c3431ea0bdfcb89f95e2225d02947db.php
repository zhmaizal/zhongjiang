<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\wamp\www\zhongjiang\public/../app/admin\view\inrtoduce\inrtoduce_add.html";i:1498637240;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('inrtoduce/inrtoduce_add'); ?>">
        <div class="row cl">
