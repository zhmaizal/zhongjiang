<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"E:\wamp\www\zhongjiang\public/../app/admin\view\classification\classification_add.html";i:1499073409;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('classification/classification_add'); ?>">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" -value="" placeholder="" id="articletitle" name="conment">
            </div>
        </div>
        <div class="row cl">
