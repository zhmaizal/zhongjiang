<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\wamp\www\zhongjiang\public/../app/admin\view\feedbacklist\feedbacklist_add.html";i:1498803925;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        <div class="row cl">
          ...
          <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder=""  name="conment">
            </div>
        </div>
