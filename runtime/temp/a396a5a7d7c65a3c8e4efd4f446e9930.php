<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\wamp\www\zhongjiang\public/../app/admin\view\message\message_upd.html";i:1498732638;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('message/message_upd'); ?>">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>联系人</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['contacts']; ?>" placeholder="" id="articletitle" name="contacts">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">联系电话</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['number']; ?>" placeholder="" id="articletitle2" name="number">
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>内容</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="<?php echo $oldData['content']; ?>" placeholder="" id="articletitle1" name="content">
                </div>
            </div>
        </div>
      <!--   <div class="row cl">
