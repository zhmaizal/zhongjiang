<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\wamp\www\zhongjiang\public/../app/admin\view\base\base_upd.html";i:1498717293;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
    <form action="<?php echo url('base/base_upd'); ?>" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        <div class="row cl">
