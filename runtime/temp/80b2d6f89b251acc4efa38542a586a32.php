<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\wamp\www\zhongjiang\public/../app/admin\view\industry\industry_upd.html";i:1498808248;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
    <form action="<?php echo url('industry/industry_upd'); ?>" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        <div class="row cl">
