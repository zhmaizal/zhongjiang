<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\wamp\www\zhongjiang\public/../app/admin\view\introduction\introduction_upd.html";i:1498701569;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $oldData['leibie']; ?>" placeholder=""  name="leibie">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">规格</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $oldData['guige']; ?>" placeholder="" name="guige">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $oldData['jiage']; ?>" placeholder="" name="jiage">
			</div>
		</div>
		<div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">特点</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['tedian']; ?>" placeholder="" name="tedian">
            </div>
        </div>
		...
		<!-- <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:$('#datemax').val()||'%y-%M-%d' })" id="datemin" class="input-text Wdate" style="width:180px;">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">销售结束时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:$('#datemin').val() })" id="datemax" class="input-text Wdate" style="width:180px;">
			</div>
		</div>
		<div class="row cl"> -->
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					...
					<div id="filePicker" style="position: relative;background: #0099FF;border-radius: 4px;padding:3px 5px">
                        <input type="file" name="file" style="opacity: 0;position: absolute" id="input" onchange='show()'/>选择图片</div>
				</div>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                    ...
                    <div class="uploader-list-container">
                        <div class="queueList">
                            <ul class="filelist"><li id="WU_FILE_0">
                                <p class="imgWrap">

                                <img src='<?php echo $oldData['image']; ?>'' alt='' id='img' />
                                </p>
                             </li>
                                </ul>
...
<script type="text/javascript" src="__STATIC__/admin/lib/picture.js"></script>
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: '/tp5.0.9/public/static/admin/lib/webuploader/0.1.5/server/fileupload.php',
            // runtimeOrder: 'flash',
