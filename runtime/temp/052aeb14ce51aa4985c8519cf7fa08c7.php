<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\wamp\www\zhongjiang\public/../app/admin\view\tianjia\tianjia.html";i:1499068739;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a class="btn btn-primary radius" data-title="添加资讯" data-href="<?php echo url('tianjia_add'); ?>" onclick="Hui_admin_tab(this)" href="javascript:;">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','<?php echo url('tianjia_upd',['id'=>$vo['id']]); ?>','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
