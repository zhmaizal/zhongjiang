<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\wamp\www\zhongjiang\public/../app/admin\view\become\become_upd.html";i:1498716675;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('become/become_upd'); ?>">
        <div class="row cl">
