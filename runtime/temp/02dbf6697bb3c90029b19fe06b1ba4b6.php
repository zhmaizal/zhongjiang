<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\wamp\www\zhongjiang\public/../app/admin\view\inrtoduce\inrtoduce_upd.html";i:1498704752;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('inrtoduce/inrtoduce_upd'); ?>">
        <div class="row cl">
