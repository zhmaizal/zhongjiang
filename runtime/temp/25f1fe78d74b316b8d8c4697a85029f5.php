<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\wamp\www\zhongjiang\public/../app/admin\view\feedbacklist\feedbacklist_upd.html";i:1498805255;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
    <form action="<?php echo url('feedbacklist/feedbacklist_upd'); ?>" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        <div class="row cl">
