<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\wamp\www\zhongjiang\public/../app/admin\view\outlook\outlook_upd.html";i:1498715586;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
    <form action="<?php echo url('outlook/outlook_upd'); ?>" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        <div class="row cl">
