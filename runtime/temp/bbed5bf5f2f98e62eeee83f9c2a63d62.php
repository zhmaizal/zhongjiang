<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\wamp\www\zhongjiang\public/../app/admin\view\article\article_upd.html";i:1498642474;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
    <form action="<?php echo url('article/article_upd'); ?>" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['article_title']; ?>" placeholder=""  name="article_title">
            </div>
        </div>
                    ...
                    <div class="uploader-list-container">
                        <div class="queueList">
                            <ul class="filelist"><li id="WU_FILE_0">
                                ...
                                <img src='<?php echo $oldData['article_image']; ?>' alt='' id='img' />
                                </p>
                             </li>
                                </ul>
        ...
        <input type="hidden" name="article_id" value="<?php echo input('param.article_id'); ?>">
        <div class="row cl">
