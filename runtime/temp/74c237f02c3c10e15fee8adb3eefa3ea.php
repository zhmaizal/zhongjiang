<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"E:\wamp\www\zhongjiang\public/../app/admin\view\technology\technology_upd.html";i:1498714347;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('technology/technology_upd'); ?>">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['title']; ?>" placeholder="" id="articletitle" name="title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">分类：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $oldData['content']; ?>" placeholder="" id="articletitle2" name="content">
            </div>
        </div>
      <!--   <div class="row cl">
